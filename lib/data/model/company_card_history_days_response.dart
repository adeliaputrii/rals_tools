...
part 'company_card_history_days_response.g.dart';

@JsonSerializable(fieldRename: FieldRename.snake)
class CompanyCardHistoryDaysResponse {
  int? status;
  String? message;
  List<Data>? data;

  CompanyCardHistoryDaysResponse({this.status, this.message, this.data});

  CompanyCardHistoryDaysResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
