...
class MyActivityBody {
  ...
  String? task_id;
  String? projek_id;
  String? myactivity_status;
  String? myactivity_desc;
  String? dokumen;
  String? date_create;

  MyActivityBody({this.user_create, this.time_start, this.time_end, this.task_id, this.projek_id, this.myactivity_desc, this.dokumen, this.date_create, required String myactivity_status});
  ...
  MyActivityBody.fromJson(Map<String, dynamic> json) {
    ...
    myactivity_status = json['myactivity_status'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['myactivity_status'] = this.myactivity_status;
