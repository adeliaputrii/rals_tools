...
class _ReportService implements ReportService {
  ...
  Future<SalesReportResponse> getSalesReport(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(reportBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SalesReportResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = SalesReportResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<SalesReportStoreResponse> getStore(
    ...
    _data.addAll(reportBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SalesReportStoreResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = SalesReportStoreResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ResponseReportDynamic> getReportdynamicHeader(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseReportDynamic>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
            ...
            .compose(
              _dio.options,
              'v1/report/report-dynamic-header',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = ResponseReportDynamic.fromJson(_result.data!);
    return value;
  }
