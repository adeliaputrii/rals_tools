...
class _StockOpnameService implements StockOpnameService {
  ...
  Future<StockOpnameResponse> getPosLocation(
    ...
    final value = StockOpnameResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<StockOpnameSubmitResponse> postResult(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<StockOpnameSubmitResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = StockOpnameSubmitResponse.fromJson(_result.data!);
    return value;
  }
