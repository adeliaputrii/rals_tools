    ...
    return Scaffold(
      appBar: AppBar(
        ...
        Container(
          ...
          child: Text('Riwayat Transaksi', style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 23, color: Colors.white,fontWeight: FontWeight.w500 )))),
              ...
              Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text('Tahun', style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 20, color: Colors.black,))),
                      Text('Total', style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 20, color: Colors.black,))),
                    ],
                  ),
               Container(
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                          ...
                          child: Icon(Icons.attach_money_outlined, color: Colors.white, size: 25,),
                                          ...
                                          title: Text('${e.tahun}', style:GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 20, color: Colors.black,)),),
                                          trailing: Text('Rp. ${kondisiSelisih()}', style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 20, color: Colors.black,)),),
                                          ),
                                        ),
                  );
                                 }).toList(),
