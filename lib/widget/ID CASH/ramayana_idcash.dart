                  ...
                  Column(
                    children: ApprovalIdcashCustomer.approvalidcashcust.map(
                      (e) {
                        ...
                        return Text(
                          'Rp. ${kondisiSelisih()}',
                          style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 40, color: Colors.white,fontWeight: FontWeight.w500 ))
                        );
                      },
                    ).toList(),
                  ),
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(
                        'No. Kartu ID CASH',
                       style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 17, color: Colors.white))
                      ),
                    ],
                  ),
                  Column(
