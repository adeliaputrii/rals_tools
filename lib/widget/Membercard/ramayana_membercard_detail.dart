...
class _RamayanaMemberCardDetailState extends State<RamayanaMemberCardDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(child: BlocBuilder<CompanyCardCubit, CompanyCardState>(
          ...
          if (state is CompanyCardDetailSuccess) {
            final balance =
                (int.tryParse(state.response.data?.first.saldo ?? '0') ?? 0) -
                    (int.tryParse(
                            state.response.data?.first.pemakaian ?? '0') ??
                        0);
            return ListView(
              children: [
                Stack(
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          crossAxisAlignment: typeCard()
                                              ? CrossAxisAlignment.start
                                              : CrossAxisAlignment.end,
                                          children: [
                                            Container(
                                              margin: EdgeInsets.only(
                                                  top: typeCard() ? 130 : 160),
                                              child: Center(
                                                child: Text(
                                                    '${balance.toIdr()}',
                                                    style: GoogleFonts
