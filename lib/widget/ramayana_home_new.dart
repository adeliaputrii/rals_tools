...
class _RamayanaState extends State<Ramayana> with WidgetsBindingObserver {
  ...
  fetchDataJumlahTask() async {
    ...
    final responseku = await http.get(
        Uri.parse('${base_url_prod}/api/v1/activity/task/count-unread'),
        headers: {
        ...
        for (var activityy in list) {
          ...
          loginCubit.stream.listen((state) {
            if (state is CreateLogSuccess) {
              db.deleteActivityy(id);
              print(
                  'ID: $id, ID Generate: $deskripsi, Date: $datetime - Deleted');
            } else if (state is CreateLogFailure) {
              print(
                  'Failed to submit log for ID: $id. Error: ${state.message}');
            }
          });
        }
      }
      ...
      return BlocListener<HomeCubit, HomeState>(
        listener: (context, state) {
          ...
          if (state is HomeNewsSuccess) {
            ...
            List<NewsListResponse.Data> filteredItems =
                daysFilter?.where((item) {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                          ...
                                          children: [
                                            menuIconHome(
                                                baseAsset.personalMenuLogo,
                                                baseParam.menuGroupPersonal,
                                                function: () =>
                                                    showMenuBottomSheet(baseParam
                                                        .menuGroupPersonal)),
                                            menuIconHome(
                                                baseAsset.toolsMenuLogo,
                                                ...
                                                function: () =>
                                                    showMenuBottomSheet(
                                                        baseParam
                                                            .menuGroupTools)),
                                            menuIconHome(
                                                baseAsset.reportMenuLogo,
                                                baseParam.menuGroupReport,
                                                function: () => AppNavigator
                                                    .navigateToReportSalesList(
                                                        context)),
                                          ]),
                                    ),
                                    // ),
                                                            ...
                                                            Expanded(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Text(
                                                                  ...
                                                                  maxLines:
                                                                      2, // Limit the number of lines for text
                                                                ),
                                                              ),
                                                            ),
                                                          ],
                                    ...
                                    BlocBuilder<IDCashCubit, IDCashState>(
                                      builder: (context, state) {
                                        if (state is IDCashSuccess &&
                                          ...
                                          member = state
                                              .response.data!.first.nokartu
                                              .toString();
                                          pref.setString('noMember', member);
                                        } else if (state is IDCashSuccess) {
...
Widget menuIconHome(String asset, String title,
    ...
    child: Column(children: [
      CircleAvatar(
        ...
        child: Image.asset(asset,
            height: baseSize.iconMenuHeight, width: baseSize.iconMenuWidth),
      ),
      ...
      Text('${title}',
          ...
          style: GoogleFonts.plusJakartaSans(
              fontWeight: FontWeight.w500,
              textStyle: TextStyle(
                  fontSize: 15, color: Color.fromARGB(255, 71, 70, 70)))),
    ]),
  );
}
