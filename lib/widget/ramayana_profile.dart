      ...
      appBar: AppBar(
        ...
        elevation: 0 ,
         ...
         bottomNavigationBar: BottomNavigationBar(
          ...
          unselectedIconTheme: IconThemeData(color: Color.fromARGB(255, 216, 216, 216), size: 23),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      SizedBox(
                                       ...
                                       Container(
                                        margin: EdgeInsets.only(left: 20),
                                         child: Text(userData.getFullname() == null ? '-' : '${userData.getFullname()}',
                                          style: GoogleFonts.plusJakartaSans(
                                          textStyle: TextStyle(
                                            fontSize: 17,
                                            color: Color.fromARGB(255, 71, 70, 70))), ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      SizedBox(
                                       ...
                                       Container(
                                        margin: EdgeInsets.only(left: 20),
                                         child: Text(userData.getEmail() == null ? '-' : '${userData.getEmail()}',
                                          style: GoogleFonts.plusJakartaSans(
                                          textStyle: TextStyle(
                                            fontSize: 17,
                                            color: Color.fromARGB(255, 71, 70, 70))), ),
                      ...
                      Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      SizedBox(
                                       ...
                                       Container(
                                        margin: EdgeInsets.only(left: 20),
                                         child: Text(userData.getUsernameID() == null ? '-' : '${userData.getUsernameID()}',
                                          style: GoogleFonts.plusJakartaSans(
                                          textStyle: TextStyle(
                                            fontSize: 17,
                                            color: Color.fromARGB(255, 71, 70, 70))), ),
                        ...
                        Center(
                          child: Container(
                            ...
                            child: Text('Version ${versi} Copyright RALS@2023',
                            style: GoogleFonts.plusJakartaSans(
                                          textStyle: TextStyle(
                                            fontSize: 17,
                                            color: Color.fromARGB(255, 71, 70, 70))),
